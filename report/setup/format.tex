...
% xelatex 模式：使用 xeCJK 的字体定义（使用 macOS 系统字体）
\setCJKfamilyfont{song}{STSong}              % 宋体
\setCJKfamilyfont{fs}{STFangsong}            % 仿宋体
\setCJKfamilyfont{kai}{STKaiti}              % 楷体
\setCJKfamilyfont{hei}{STHeiti}              % 黑体
\setCJKfamilyfont{li}{STLiti}                % 隶书
...
%\cleardoublepage%
   \phantomsection
    ...
    \begin{titlepage}
      ...
      \includegraphics[width=0.32\textwidth]{figures/tju}
      \vspace*{8pt}
      ...
      \includegraphics[width=0.20\textwidth]{figures/Tjulogo}
      ...
      \setlength{\@title@width}{7cm}
      {
        \sanhao\song{
          \begin{tabular}{lc}
            ...
            \textbf{组\qquad 号}  &  \underline{\makebox[\@title@width][c]{\textbf{\@cgrade}}}\\
            \textbf{小组成员}  &  \@cauthor\\
          \end{tabular}
        }
    }
